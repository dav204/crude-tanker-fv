...
**STATE INSERT (2026-09-18 — WO5/R4 Phases 0-3b AND Phase 4 COMPLETE; Phase 5 is the owner's).** The crude deck is re-expressed against the live base and the three Stage-A void dispositions are ruled, one commit each: **CAPT RETIRED** (sole ground was the deck artifact, now gone — reads TRIM/SHORT -6.0, TRIM across all 8 weight sets), **TNK RETIRED to POSITION_CYCLE_RELABEL** (per the WO's pre-ruled item 6 — rich/rich at TIGHT is the same late-cycle shape as its crude peers, not a short thesis), **BRUT UPHELD** (two grounds; the re-expression reaches only the junior one, and its live 4-hull entity has never filed a balance sheet — re-armed to the Oslo uplisting prospectus ~end-Sep, dated fallback at the Q3 report 2026-11-19). Records: `decisions/{capt,tnk,brut}_void_disposition_2026-09-18.md`. The B1 docket RE-ARMS (not ruled) as its anchor moved with TNK. **OWNER OWES (Phase 5):** the ratify over the per-name-decomposed causes and the push. **Watch:** CAPT now renders a raw band with NO hysteresis 0.97pp from the HOLD edge (TRIM<->HOLD strobe, not BUY); a BUY-ward re-cross on CAPT is an armed owner eyeball. **Still routed, not resolved:** the crude WEIGHT question (59% of mass on a base-tracking leg, 13% on the only real downside) and the product deck's own re-expression.
...
- **SBLK** — equity offering PRICED (6-K 0000950157-26-001003, 9/11): 4,400,000 new shares at €24.50 / US$28.40, ≈US$125.0M gross, settlement 9/15. Next vintage: count 111,671,386 → **116,071,386** (UNVERIFIED — post-6/30 repurchases undisclosed) and +$125.0M cash as a **Q3** event (no 6/30-dated sheet moves). Record: decisions/sblk_log.md 2026-09-12.
  - **SUPERSEDED IN PART 2026-09-16** by the results 6-K 0000950157-26-001013 (9/15): count **116,071,386 is now ISSUER-STATED** (ex-99.2 admission header) rather than a derived walk — drop the UNVERIFIED flag to "issuer-corroborated" (caveat: the admission does not say in terms it is net of treasury); cash leg is **+US$115.9M NET** (€100.4M, after €7.4M/$8.5M expenses), not +$125.0M gross; gross restated US$124.4M on the 15.09 ECB rate (€107.8M is the invariant). Use-of-proceeds independently re-cites the **$65.8M remaining commitment** on Irini/Aline/Argyro. Record: decisions/sblk_log.md 2026-09-16.
  - **TREASURY CAVEAT NARROWED 2026-09-17** by the Law 3556/2007 announcements (6-K 0000950157-26-001022, 9/16): ex-99.2 gives **116,071,386 shares "in circulation" and 116,071,386 voting rights** as the statutory disclosure denominator — a third, independent statement of the count, and a denominator that excludes treasury by construction. It does NOT state a treasury figure, so the flag stays open for the owner-present sheet build, but it is now "issuer-corroborated ×2, treasury not quantified" rather than an open question about the count itself. Record: decisions/filings_triage_log.md 2026-09-17.
- **HAFN** — TORM stake increased (6-K 0001140361-26-036707, 9/16): agreed to acquire **4,500,000 TORM A shares at US$32.25 ≈ US$145.1M** (4.39% of TORM), holding to **~18.22%**. The stake is a load-bearing `working_capital_net` leg (Q2: 13.97% at $277.2M, lower-of-market-or-purchase-price). A **Q3 cash-for-investment SWAP: ΔNAV ≈ 0 only if the cash leg and the stake leg move TOGETHER** — moving cash alone drops NAV ≈$0.29/share for nothing. Anchor on held SHARE COUNT not percentage (13.97 + 4.39 = 18.36 vs the stated 18.22 — moving denominator), re-test the lower-of on the aggregate, and pick up the disclosed funding (Q2 cash was $271.0M, below the consideration). Record: decisions/hafn_log.md 2026-09-16.
  - **PRICE CORROBORATED 2026-09-17** by TRMD's own filing (6-K 0000919574-26-006339, 9/16): the Oaktree secondary priced 9,000,000 Class A shares at US$290,250,000 gross = **US$32.25/share**, the exact price HAFN stated. So HAFN's 4,500,000 shares were an **allocation in that registered offering** (half the base deal), not an off-market block — the consideration is a clean arm's-length market clearing price for the lower-of-market-or-purchase-price test, and the settlement date is the offering's 9/16 delivery. Record: decisions/filings_triage_log.md 2026-09-17.
- **TRMD** — RSU capital increase (6-K 0000919574-26-006252, 9/11): +31,483 Class A shares at DKK 179.80, share capital now **102,421,267** A-shares (USD 1,024,212.67 nominal). +0.031% — below any gate, so no decisions/trmd_log.md entry was written (it would read as a drift-gate annotation for a non-event); the next TRMD vintage just carries the count. Record: decisions/filings_triage_log.md 2026-09-12.
  - **CLOSED 2026-09-17** on the Oaktree secondary (6-K 0000919574-26-006339, 9/16): 9,000,000 Class A shares sold **by OCM Njord**, US$290,250,000 gross to the Selling Shareholder (US$32.25/share), delivered 9/16, option on 1,350,000 unexercised, Oaktree to ~11.06%. The Company sold nothing and received nothing — **count and cash unchanged**, so the count above is still the only TRMD carry. Record: decisions/filings_triage_log.md 2026-09-17.
- **FRO — NO FIGURE MOVES, logged for provenance only** (opened 2026-09-17): the H1-2026 inline-XBRL interim financial statements landed (6-K 0001628280-26-062234, 9/16) — the **statutory NOTED version** of the 2026-06-30 period already built in `inputs/balance_sheets/fro_2026-Q2.yaml` from the note-less 8/28 exhibit. Every NAV driver reconciles to the dollar (cash, debt 2,434,842, working capital 368,023, Newbuildings 225,770, the $601.1M commitment and its $313.0M/$198.3M/$89.8M split, 222,622,889 shares). Two consequences, neither a figure move: (a) the sheet's header caveat *"the exhibit carries NO statement notes"* is now **superseded** — the Q2 figures have a fully noted interim statement behind them, which is a provenance upgrade worth citing at the next FRO touch; (b) two disclosures are new and currently outside the sheet — **TFG Marine remaining commitment $6.7M** and **investment in associated companies 8,791 → 32,539** (non-current, excluded from the working-capital construction by design). Both are ~$0.03 and ~$0.15/share respectively; whether the associate stake belongs in NAV is a **methodology question for the owner**, not a sheet fix. Record: decisions/filings_triage_log.md 2026-09-17.
- **TEN — THE H1-2026 6-K LANDED** (6-K 0001193125-26-394366, filed 9/17; opened 2026-09-18): the filing the STILL-OPEN item "TEN Q2 sheet when the 6-K lands" was waiting for. Staged doc is 1.3MB single-file iXBRL, **unreadable by the Read tool** — figures from the EDGAR R-renderings. Every release-sourced field ties to the dollar (cash 463,989 + restricted 2,154 = 466,143; debt 250,376 + 1,851,801 = 2,102,177; advances 470,050; equity 2,054,657) and the WC composite decomposes exactly (Other assets 286,240 / Other liabilities 220,881), so the shadow's component-level UNVERIFIED closes. **Three of the shadow's open items RESOLVE:** (9.2) the Vessels note states the Company **acquired** Arctic (5/28) and Antarctic (6/11) — **owned at 6/30, the conservative OUT was wrong**; re-add 56→58 hulls, Suezmax 14→16, **+$2.26 to +$2.39/sh**, per-vessel price to be cited off the note prose (R38 renders only $20,000 against Antarctic); (9.1) Archangel sold 8/14 and Alaska 8/26, no HFS caption at 6/30 — rows stay on-curve, the −$2.04/sh flip does not fire; (9.4) 30,127,603 outstanding / 678,173 treasury, issuer-stated and unchanged; (9.3) NCI **50,130**, the rolled figure. **NEW AND OWNER-FACING:** the Commitments note puts **20 vessels under construction** (10 DP2 shuttles, 2 LNG carriers, 3 VLCCs, 5 LR1s) with **$2,233,409K remaining** (228,339 / 723,029 / 1,127,374 / 154,667 for H2-26 / 27 / 28 / 29, sums exact) against the sheet's advances-only `newbuild_capex_commitments: 0` — ~$74/share of gross obligation the NAV does not net. That is the TEN instance of the GSL/CMBT/BWLP commitment-net convention and belongs in `inputs/forks.yaml` **before** any §9.6 wiring, not in a sheet edit. Envelope on the shadow's NAV/sh 89.61 narrows ~87.4–92.0 → ~**91.7–92.0** pre-commitment; BUY / GOVERNED-WIDE insensitive. Record: decisions/ten_log.md 2026-09-18.
...
3. **R4: the Stage-A voids are DISPOSED (2026-09-18, WO5/R4 Phase 4 — supersedes the "voids STAND" framing).** The deck re-expression the voids were waiting on landed (Phases 0-3b, `decisions/r4_deck_reexpression_method_2026-09-18.md`) and all three were ruled, one commit each. **CAPT RETIRED** — its only ground was the deck artifact and the artifact is gone; it now reads TRIM/SHORT -6.0 (NOT BUY-ward: the "CAPT is the ONE BUY-ward void at tape (+9-10%)" framing is dead) and TRIM across all 8 weight sets; the cell prints the raw band and read_blocked / GOVERNED-WIDE / newbuild-heavy STAND. **TNK RETIRED to `POSITION_CYCLE_RELABEL`** (WO item 6, pre-ruled): rich/rich at TIGHT is the same late-cycle shape as its crude peers, not a short thesis. **BRUT UPHELD** — alone of the three it has TWO grounds and the re-expression reaches only the junior one; its live 4-hull entity has never filed a balance sheet and the constructed Q2 sheet was accepted under its own premise that the read is void regardless. Re-armed to the Oslo uplisting prospectus (~end-Sep), dated fallback at the Q3 report 2026-11-19. Records: `decisions/{capt,tnk,brut}_void_disposition_2026-09-18.md`. Correction to the wf_8b0d1184 framing carried above: that record refuted the PERSISTENCE of TNK's BUY-ward read, not the original 8/10 print, which was real at that day's live tape.
...
(1) **Mon 8/18:** the URGENT sitting above · fold GNK **Diana-withdrawal** (offer withdrawn 8/14, digest M1 — retire the live-proposal watchlist caveat; the 28.40 Pareto-NAV value may stand; re-read: current T/S is the last *with-deal* read) · **S&P candidates TRIAGED 8/16** (`decisions/sp_candidates_triage_2026-08-16.md`: Bristol DISMISSED — issuer PR discloses gain only, no price, back-solve prohibited, price-watch rides the 8/27 CMBT stop; the 8/10 Kamsarmax pair $38.2/23.5M swept clean of re-reports and **RECOMMENDED PROMOTE — owner round Monday**, the one live promotion decision) · FRO 2×VLCC print watch stands (MB W33/W34; P1 unpromoted — blocker is vessel names, GlobeNewswire primary timed out 3×).
...
(4) **The earnings train — prereg BEFORE each print (INSW/BRUT pattern), subsequent-events note FIRST, term-rate disclosures captured as Stage-B class-bucket basis:** **8/26** TRMD Q2 (+ the LR1/anchor-round TIGHT candidacy queues behind it) + MPCC H1 (amended prereg) + NAT window opens · **8/27** CMBT · **8/19 FLNG — MOVED, early-release risk FIRED (issuer invitation confirmed 8/18; prereg `decisions/flng_q2_prereg_2026-08-18.md` written+frozen 8/18, band [25.40,29.80])** · **8/28** HAFN + BWLP (§9.6 first instalment on the 8-hull order, NCI re-derivation if the curve moved, R-2 orderbook re-read) · **8/31** FRO · **9/01** CAPT (the M2/M3 deliveries vs the 31-Mar sheet land here; SLB vs senior-secured — the ECO double-count trap on the first only).
...
(6) **Owner words open:** deck re-expression WO (R4) scheduling · `hormuz_fee_collection_watch` due date · June 1–3 Pareto archive gap CLOSED 8/16 (its own RC walk: source-quiet, sender's contemporaneous non-publication note; archive_gaps.yaml) · news-pull limitations backlog (the 8-item 8/16 digest handoff — GlobeNewswire 60s timeout, sec.gov/efts 403 EDGAR route, hellenic/splash 403s, PDF-primaries→fetch_pdf, JS-shell IR pages, Glob/Grep restore-or-bless, the missing 8/14 daily; the NewsWeb item CLOSED same day by `newsweb_poll`) · PANL seed scheduling (Stage-3; B3 WAITING-ON-IR since 8/12) · TEN alternative-anchor · BRUT demerger modeling (demerger end-Aug, uplist end-Sep — newsweb now watches the releases) · watchdog-sweep residuals (sentinel CI-status lane; EARNINGS-* tags unrouted + trailing-colon; overlays.yaml Jun-9 scopes + dead `retire_trigger`; 2 zombie ctxprobe plists) · `_fetch` URLError exposure shared by hkex/newsweb (module-level fix, per df67019).
