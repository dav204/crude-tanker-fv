...
- **Probability-weighted fair value:** $27.57 (-30.6% vs price)
- **Breakeven TCE (scenario-invariant):** $545,468/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
| Pre-MoU baseline | 57% | 0.96× | $23.95 | $24.41 | $23.72–$25.15 | 2.46× | 0.70 | $25.49 | $89,867 | 0.16× |
...
- **Downside (worst scenario − price):** $-22.42
- **Expected value vs current** (weighted FV − price): $-12.17 (-30.6%)
