...
- **Probability-weighted fair value:** $28.29 (-36.2% vs price)
- **Breakeven TCE (scenario-invariant):** $720,125/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $35.19 | $41.29 | $39.55–$43.30 | 7.70× | 0.70 | $55.53 | $283,063 | 0.39× |
...
- **Downside (worst scenario − price):** $-25.97
- **Expected value vs current** (weighted FV − price): $-16.03 (-36.2%)
