...
- **Probability-weighted fair value:** $2.97 (-63.3% vs price)
- **Breakeven TCE (scenario-invariant):** $873,534/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
- **Expected value vs current** (weighted FV − price): $-5.12 (-63.3%)
