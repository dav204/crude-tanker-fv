...
- **Probability-weighted fair value:** $2.72 (-56.0% vs price)
- **Breakeven TCE (scenario-invariant):** $431,629/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $3.75 | $4.48 | $4.25–$4.75 | 5.36× | 0.70 | $6.20 | $148,750 | 0.34× |
...
- **Expected value vs current** (weighted FV − price): $-3.45 (-56.0%)
