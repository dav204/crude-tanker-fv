...
- **Probability-weighted fair value:** $0.38 (-28.9% vs price)
- **Breakeven TCE (scenario-invariant):** $39,039/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
| Moderate growth (base) | 40% | 0.94× | $0.38 | $0.38 | $0.36–$0.39 | 1.21× | 0.60 | $0.37 | $16,295 | 0.42× |
...
- **Expected value vs current** (weighted FV − price): $-0.15 (-28.9%)
