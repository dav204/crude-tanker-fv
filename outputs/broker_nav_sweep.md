...
| SBLK | 0.82× | 1.04 | +12.1% | +14.4% | +16.6% | BUY→BUY | $9,650→NAV>px | +5 | narrow-spread |
| SB | 0.88× | 0.83 | +53.4% | +34.0% | +14.5% | BUY→BUY | NAV>px→NAV>px | -39 | wide-spread |
| CMBT **(WHOLE-CO)** | 0.74× | 1.14 | -8.3% | +2.4% | +13.1% | TRIM/SHORT→BUY | $52,880→NAV>px | +21 | wide-spread |
...
| CAPT | 0.67× | 1.18 | -26.4% | -13.2% | +0.0% | TRIM/SHORT→HOLD | $6,063→NAV>px | +26 | wide-spread |
...
| BRUT | 0.75× | 0.94 | -41.4% | -53.4% | -65.5% | TRIM/SHORT→TRIM/SHORT | NAV>px→NAV>px | -24 | wide-spread |
