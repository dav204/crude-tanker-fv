...
| CMBT **(WHOLE-CO)** | 0.74× | 1.11 | +14.4% | +24.3% | +34.3% | BUY→BUY | $40,799→NAV>px | +20 | wide-spread |
...
| INSW **(WHOLE-CO)** | 0.98× | 1.51 | -21.1% | -5.0% | +11.2% | TRIM/SHORT→BUY | $262,407→$70,042 | +32 | wide-spread |
