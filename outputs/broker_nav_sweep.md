...
|---|--:|--:|--:|--:|--:|---|--:|--:|---|
| TEN | 0.34× | 1.16 | +68.6% | +86.9% | +105.3% | BUY→BUY | NAV>px→NAV>px | +37 | wide-spread |
...
| TNK | 0.76× | 1.39 | +1.7% | +12.7% | +23.8% | HOLD→BUY | $39,706→NAV>px | +22 | wide-spread |
...
| SBLK | 0.82× | 1.21 | -5.3% | +5.8% | +16.8% | TRIM/SHORT→BUY | $28,367→NAV>px | +22 | wide-spread |
| GNK | 0.87× | 1.03 | +8.6% | +10.4% | +12.3% | BUY→BUY | $16,716→$12,427 | +4 | narrow-spread |
| HAFN | 0.95× | 1.37 | -20.8% | -5.8% | +9.1% | TRIM/SHORT→BUY | $110,531→$27,874 | +30 | wide-spread |
| INSW **(WHOLE-CO)** | 0.98× | 1.61 | -28.0% | -9.5% | +9.0% | TRIM/SHORT→BUY | $392,822→$71,660 | +37 | wide-spread |
...
| CMDB | 0.62× | 0.86 | +12.6% | +6.0% | -0.7% | BUY→HOLD | NAV>px→$1,070,509 | -13 | wide-spread |
