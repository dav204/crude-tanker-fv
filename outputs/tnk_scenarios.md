...
- **Probability-weighted fair value:** $83.24 (-17.4% vs price)
- **Breakeven TCE (scenario-invariant):** $258,112/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
- **Downside (worst scenario − price):** $-30.37
- **Expected value vs current** (weighted FV − price): $-17.59 (-17.4%)
