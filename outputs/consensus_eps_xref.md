...
|---|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|---|
| CAPT | crude | $16.06 | 25.5× | $0.63 | $2.58 | 6.2× | +310% | 3.9% | 2.36× (late-cycle/peak) | 0.30 | earnings-driven (tool>cons) |
...
| CMDB | dry_bulk | $17.25 | 10.5× | $1.64 | $5.30 | 3.3× | +223% | 9.5% | 1.48× (elevated) | 0.40 | earnings-driven (tool>cons) |
...
| GNK | dry_bulk | $25.80 | 12.3× | $2.10 | $5.91 | 4.4× | +182% | 8.1% | 1.48× (elevated) | 0.40 | earnings-driven (tool>cons) |
| 2343 | dry_bulk | $0.53 | 17.8× | $0.03 | $0.08 | 6.4× | +178% | 5.6% | 1.23× (elevated) | 0.40 | earnings-driven (tool>cons) |
| CCEC | lng | $22.80 | 7.9× | $2.89 | $7.95 | 2.9× | +175% | 12.7% | 0.78× (below-mid) | 0.60 | earnings-driven (tool>cons) |
| CMBT | crude | $18.30 | 10.3× | $1.78 | $4.57 | 4.0× | +157% | 9.7% | 1.77× (late-cycle/peak) | 0.30 | earnings-driven (tool>cons) |
...
| SB | dry_bulk | $8.52 | 6.5× | $1.31 | $2.19 | 3.9× | +67% | 15.4% | 1.70× (late-cycle/peak) | 0.30 | earnings-driven (tool>cons) |
| SBLK | dry_bulk | $30.40 | 7.1× | $4.28 | $7.00 | 4.3× | +64% | 14.1% | 1.54× (late-cycle/peak) | 0.30 | earnings-driven (tool>cons) |
