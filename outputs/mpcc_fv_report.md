...
|---|---:|---:|
| **Implied breakeven (blended)** | **108,107** | — |
| 10-year mean | 30,057 | 3.60× |
| 12-month FFA | 36,179 | 2.99× |
| Current spot | 36,908 | 2.93× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Ctr-Intermediate (72% of fleet value) | 126,939 | 3.77× |
| Ctr-Feeder (28% of fleet value) | 60,509 | 2.90× |
...
_Current price $2.42. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$2.19** is -9.5% vs the current price ($2.42) and -16.8% vs the analyst target ($2.63). The current price implies the fleet earning a value-weighted blended **$108,107/day** (2.99× the current forward) — 3.6× the value-weighted 10-yr mean ($30,057, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
