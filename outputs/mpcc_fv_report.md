...
|---|---:|---:|
| **Implied breakeven (blended)** | **144,987** | — |
| 10-year mean | 30,008 | 4.83× |
| 12-month FFA | 38,662 | 3.75× |
| Current spot | 40,000 | 3.62× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Ctr-Intermediate (71% of fleet value) | 168,100 | 4.99× |
| Ctr-Feeder (29% of fleet value) | 87,660 | 4.20× |
...
_Current price $2.57. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$2.21** is -14.0% vs the current price ($2.57) and -16.0% vs the analyst target ($2.63). The current price implies the fleet earning a value-weighted blended **$144,987/day** (3.75× the current forward) — 4.8× the value-weighted 10-yr mean ($30,008, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
