...
The current price requires the fleet to run at **5.00× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **316,222** | — |
| 10-year mean | 85,000 | 3.72× |
| 12-month FFA | 63,250 | 5.00× |
| Current spot | 65,000 | 4.86× |
...
_Current price $31.70. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$27.01** is -14.8% vs the current price ($31.70) and +8.0% vs the analyst target ($25.00). The current price implies the fleet earning a value-weighted blended **$316,222/day** (5.00× the current forward) — 3.7× the value-weighted 10-yr mean ($85,000, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
