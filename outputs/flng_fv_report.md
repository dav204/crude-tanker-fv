...
The current price requires the fleet to run at **2.14× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **135,338** | — |
| 10-year mean | 85,000 | 1.59× |
| 12-month FFA | 63,250 | 2.14× |
| Current spot | 65,000 | 2.08× |
...
_Current price $29.50. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$28.16** is -4.5% vs the current price ($29.50) and +12.7% vs the analyst target ($25.00). The current price implies the fleet earning a value-weighted blended **$135,338/day** (2.14× the current forward) — 1.6× the value-weighted 10-yr mean ($85,000, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
