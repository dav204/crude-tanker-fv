...
The current price requires the fleet to run at **4.52× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **286,002** | — |
| 10-year mean | 85,000 | 3.36× |
| 12-month FFA | 63,250 | 4.52× |
| Current spot | 65,000 | 4.40× |
...
_Current price $31.14. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$27.01** is -13.3% vs the current price ($31.14) and +8.0% vs the analyst target ($25.00). The current price implies the fleet earning a value-weighted blended **$286,002/day** (4.52× the current forward) — 3.4× the value-weighted 10-yr mean ($85,000, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
