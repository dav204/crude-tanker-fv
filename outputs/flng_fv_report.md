...
|---|---:|---:|
| **Implied breakeven (blended)** | **57,631** | — |
| 10-year mean | 85,000 | 0.68× |
| 12-month FFA | 63,250 | 0.91× |
| Current spot | 40,000 | 1.44× |
...
Tool fair value **$28.16** is +0.4% vs the current price ($28.06) and +12.7% vs the analyst target ($25.00). The current price implies the fleet earning a value-weighted blended **$57,631/day** (0.91× the current forward) — 0.7× the value-weighted 10-yr mean ($85,000, i.e. the market is pricing distress), and the market is below the forward curve.
