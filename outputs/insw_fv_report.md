...
> **Valuation basis:** CRUDE SLEEVE only (65.0% of vessel value). FV and price are the CRUDE sleeve / CRUDE-ALLOCATED price $67.96 (= whole-company $104.62 × crude_share). Product sleeve (~35%) is EXCLUDED from the model FV — covered qualitatively only (v2 product strip pending). Do not compare directly to whole-company P/NAV without re-aggregating.

- **Report date:** 2026-Q2
- **Current price (crude-allocated):** $67.96
...
The current price requires the fleet to run at **5.42× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **569,780** | — |
| 10-year mean | 33,465 | 17.03× |
| 12-month FFA | 105,192 | 5.42× |
| Current spot | 235,542 | 2.42× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Suezmax (45% of fleet value) | 520,262 | 18.75× |
| VLCC (40% of fleet value) | 705,509 | 17.64× |
| Aframax (10% of fleet value) | 371,036 | 10.17× |
| LR1 (6% of fleet value) | 371,036 | 13.44× |
...
_Current price $67.96. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$37.95** is -44.2% vs the current price ($67.96) and -26.5% vs the analyst target ($51.64). The current price implies the fleet earning a value-weighted blended **$569,780/day** (5.42× the current forward) — 17.0× the value-weighted 10-yr mean ($33,465, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
