...
> **Valuation basis:** CRUDE SLEEVE only (65.0% of vessel value). FV and price are the CRUDE sleeve / CRUDE-ALLOCATED price $66.35 (= whole-company $102.14 × crude_share). Product sleeve (~35%) is EXCLUDED from the model FV — covered qualitatively only (v2 product strip pending). Do not compare directly to whole-company P/NAV without re-aggregating.

- **Report date:** 2026-Q2
- **Current price (crude-allocated):** $66.35
...
The current price requires the fleet to run at **5.18× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **544,843** | — |
| 10-year mean | 33,465 | 16.28× |
| 12-month FFA | 105,192 | 5.18× |
| Current spot | 235,542 | 2.31× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Suezmax (45% of fleet value) | 497,492 | 17.93× |
| VLCC (40% of fleet value) | 674,632 | 16.87× |
| Aframax (10% of fleet value) | 354,797 | 9.72× |
| LR1 (6% of fleet value) | 354,797 | 12.85× |
...
_Current price $66.35. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$37.95** is -42.8% vs the current price ($66.35) and -26.5% vs the analyst target ($51.64). The current price implies the fleet earning a value-weighted blended **$544,843/day** (5.18× the current forward) — 16.3× the value-weighted 10-yr mean ($33,465, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
