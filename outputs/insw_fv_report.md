...
|---|---:|---:|
| **Implied breakeven (blended)** | **597,965** | — |
| 10-year mean | 33,465 | 17.87× |
| 12-month FFA | 104,693 | 5.71× |
| Current spot | 235,542 | 2.54× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Suezmax (45% of fleet value) | 505,335 | 18.21× |
| VLCC (40% of fleet value) | 814,904 | 20.37× |
| Aframax (10% of fleet value) | 317,994 | 8.72× |
| LR1 (6% of fleet value) | 317,994 | 11.52× |
...
Tool fair value **$37.59** is -44.7% vs the current price ($67.96) and -27.2% vs the analyst target ($51.64). The current price implies the fleet earning a value-weighted blended **$597,965/day** (5.71× the current forward) — 17.9× the value-weighted 10-yr mean ($33,465, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
