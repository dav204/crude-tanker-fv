...
- **Probability-weighted fair value:** $9.09 (+3.9% vs price)
...
- **Upside (best scenario − price):** $+2.74
- **Downside (worst scenario − price):** $-1.69
- **Expected value vs current** (weighted FV − price): $+0.34 (+3.9%)
