...
- **Probability-weighted fair value:** $9.08 (-1.1% vs price)
...
- **Upside (best scenario − price):** $+2.29
- **Downside (worst scenario − price):** $-2.12
- **Expected value vs current** (weighted FV − price): $-0.10 (-1.1%)
