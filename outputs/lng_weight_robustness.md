...
## FLNG — at price $30.14, target $25.00
...
- HOLD threshold (FV ≥ $28.63, EV ≥ -5%): alpha ≥ **0.67**
- BUY threshold (FV ≥ $31.65, EV ≥ +5%): _not reachable on the [Set B → Set B-revised] line_

**Weights at the minimum HOLD threshold (alpha = 0.67):**

| Scenario | Weight at HOLD threshold | vs Set B |
|---|--:|--:|
| tight_resurgence | 0.134 | +0.034 |
| moderate_tightening | 0.217 | +0.067 |
| glut_base | 0.483 | -0.067 |
| glut_intensifies | 0.166 | -0.034 |
| structural_reset | 0.000 | +0.000 |

---

## CCEC — at price $22.38, target $25.17
...
- HOLD threshold (FV ≥ $21.26, EV ≥ -5%): _not reachable on the [Set B → Set B-revised] line_
- BUY threshold (FV ≥ $23.50, EV ≥ +5%): _not reachable on the [Set B → Set B-revised] line_
