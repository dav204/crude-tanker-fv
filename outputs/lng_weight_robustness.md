...
## FLNG — at price $30.85, target $25.00
...
- HOLD threshold (FV ≥ $29.31, EV ≥ -5%): _not reachable on the [Set B → Set B-revised] line_
- BUY threshold (FV ≥ $32.39, EV ≥ +5%): _not reachable on the [Set B → Set B-revised] line_
...
|---|--:|--:|--:|
| tight_resurgence | 0.154 | +0.054 | +0.004 |
| moderate_tightening | 0.257 | +0.107 | +0.007 |
| glut_base | 0.443 | -0.107 | -0.007 |
| glut_intensifies | 0.146 | -0.054 | -0.004 |
...
## CCEC — at price $23.35, target $25.17
...
- HOLD threshold (FV ≥ $22.18, EV ≥ -5%): _not reachable on the [Set B → Set B-revised] line_
- BUY threshold (FV ≥ $24.52, EV ≥ +5%): _not reachable on the [Set B → Set B-revised] line_
