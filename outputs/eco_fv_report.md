...
|---|---:|---:|
| **Implied breakeven (blended)** | **359,265** | — |
| 10-year mean | 33,804 | 10.63× |
| 12-month FFA | 119,602 | 3.00× |
| Current spot | 204,237 | 1.76× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Suezmax (51% of fleet value) | 255,325 | 9.20× |
| VLCC (49% of fleet value) | 465,593 | 11.64× |
...
_Current price $54.20. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$37.18** is -31.4% vs the current price ($54.20) and -17.4% vs the analyst target ($45.00). The current price implies the fleet earning a value-weighted blended **$359,265/day** (3.00× the current forward) — 10.6× the value-weighted 10-yr mean ($33,804, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
