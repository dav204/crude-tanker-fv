...
The current price requires the fleet to run at **4.32× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **500,715** | — |
| 10-year mean | 33,933 | 14.76× |
| 12-month FFA | 115,837 | 4.32× |
| Current spot | 285,242 | 1.76× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| VLCC (50% of fleet value) | 616,722 | 15.42× |
| Suezmax (50% of fleet value) | 382,439 | 13.78× |
...
_Current price $60.29. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$39.73** is -34.1% vs the current price ($60.29) and -11.7% vs the analyst target ($45.00). The current price implies the fleet earning a value-weighted blended **$500,715/day** (4.32× the current forward) — 14.8× the value-weighted 10-yr mean ($33,933, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
