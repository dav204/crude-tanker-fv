...
|---|---:|---:|
| **Implied breakeven (blended)** | **35,200** | — |
| 10-year mean | 20,184 | 1.74× |
| 12-month FFA | 27,471 | 1.28× |
| Current spot | 34,472 | 1.02× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Cape (64% of fleet value) | 42,653 | 1.80× |
| Supra-Ultra (36% of fleet value) | 21,754 | 1.56× |
...
Tool fair value **$24.61** is -4.9% vs the current price ($25.88) and -9.5% vs the analyst target ($27.20). The current price implies the fleet earning a value-weighted blended **$35,200/day** (1.28× the current forward) — 1.7× the value-weighted 10-yr mean ($20,184, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
