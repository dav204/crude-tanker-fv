...
| Item | $M |
|---|---:|
| Fleet value — Cape | 925.5 |
| Fleet value — Supra-Ultra | 500.2 |
...
| Terminal value (NAV, q9) | | | | 22.03 | 17.42 |
| **DivStrip implied price** | | | | | **$24.25** |
...
0.50 × $26.16 (NAV) + 0.50 × $24.25 (strip) = **$25.20**
...
|---|---:|---:|
| **Implied breakeven (blended)** | **18,726** | — |
| 10-year mean | 20,240 | 0.93× |
| 12-month FFA | 24,931 | 0.75× |
| Current spot | 31,510 | 0.59× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Cape (65% of fleet value) | 22,186 | 0.94× |
| Supra-Ultra (35% of fleet value) | 12,323 | 0.88× |

## Sensitivity — fair value (rows: TCE shock, cols: vessel-value shock)

| TCE \ Vessel | -20% | -10% | +0% | +10% | +20% |
|---|---:|---:|---:|---:|---:|
| **-30%** | $18.33 | $21.04 | $23.75 | $26.46 | $29.18 |
| **-15%** | $19.06 | $21.77 | $24.48 | $27.19 | $29.90 |
| **+0%** | $19.78 | $22.49 | $25.20 | $27.91 | $30.62 |
| **+15%** | $20.50 | $23.21 | $25.93 | $28.64 | $31.35 |
| **+30%** | $21.23 | $23.94 | $26.65 | $29.36 | $32.07 |

_Current price $24.00. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$25.20** is +5.0% vs the current price ($24.00) and +1.6% vs the analyst target ($24.80). The current price implies the fleet earning a value-weighted blended **$18,726/day** (0.75× the current forward) — 0.9× the value-weighted 10-yr mean ($20,240, i.e. the market is pricing distress), and the market is below the forward curve.
