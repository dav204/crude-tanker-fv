...
|---|---:|---:|
| **Implied breakeven (blended)** | **418,109** | — |
| 10-year mean | 27,747 | 15.07× |
| 12-month FFA | 85,000 | 4.92× |
| Current spot | 124,800 | 3.35× |
...
Tool fair value **$3.09** is -48.9% vs the current price ($6.05) and -48.4% vs the analyst target ($6.00). The current price implies the fleet earning a value-weighted blended **$418,109/day** (4.92× the current forward) — 15.1× the value-weighted 10-yr mean ($27,747, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
