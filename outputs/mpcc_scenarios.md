...
- **Probability-weighted fair value:** $2.06 (-18.1% vs price)
- **Breakeven TCE (scenario-invariant):** $132,543/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
- **Upside (best scenario − price):** $-0.31
- **Downside (worst scenario − price):** $-0.83
- **Expected value vs current** (weighted FV − price): $-0.46 (-18.1%)
