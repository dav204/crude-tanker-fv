...
|---|---:|---:|
| **Implied breakeven (blended)** | **11,242** | — |
| 10-year mean | 16,680 | 0.67× |
| 12-month FFA | 22,096 | 0.51× |
| Current spot | 24,801 | 0.45× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Supra-Ultra (46% of fleet value) | 8,423 | 0.60× |
| Cape (33% of fleet value) | 16,510 | 0.70× |
| Pana (21% of fleet value) | 9,228 | 0.78× |
...
_Current price $18.81. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$20.52** is +9.1% vs the current price ($18.81) and -26.6% vs the analyst target ($27.98). The current price implies the fleet earning a value-weighted blended **$11,242/day** (0.51× the current forward) — 0.7× the value-weighted 10-yr mean ($16,680, i.e. the market is pricing distress), and the market is below the forward curve.
