...
|---|---:|---:|---:|---:|---:|
| Q1 | 17,730 | 17,730 | 0.024 | 0.024 | 0.023 |
| Q2 | 18,450 | 18,450 | 0.025 | 0.025 | 0.024 |
| Q3 | 14,470 | 14,470 | 0.017 | 0.017 | 0.015 |
| Q4 | 14,710 | 14,710 | 0.017 | 0.017 | 0.015 |
| Q5 | 14,710 | 14,710 | 0.017 | 0.017 | 0.015 |
| Q6 | 14,710 | 14,710 | 0.017 | 0.017 | 0.015 |
| Q7 | 14,440 | 14,440 | 0.017 | 0.017 | 0.014 |
| Q8 | 14,170 | 14,170 | 0.016 | 0.016 | 0.013 |
| Σ discounted DPS | | | | | 0.13 |
| Terminal value (NAV, q9) | | | | 0.35 | 0.28 |
| **DivStrip implied price** | | | | | **$0.41** |

_FFA spot is the Handy-Bulk forward curve that drives the strip cash flows; its 12-month average is **$16,340/day**. Blended TCE is that spot dampened by charter coverage. Cycle weighting (below) uses a different, more conservative input — the 12-month TC of **$14,500/day** — not this FFA average._
...
The current price requires the fleet to run at **2.24× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **39,039** | — |
| 10-year mean | 13,481 | 2.90× |
| 12-month FFA | 17,442 | 2.24× |
| Current spot | 18,596 | 2.10× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Handy-Bulk (50% of fleet value) | 36,573 | 2.85× |
| Supra-Ultra (49% of fleet value) | 40,634 | 2.92× |
| Cape (1% of fleet value) | 87,040 | 3.68× |
...
Tool fair value **$0.41** is -22.0% vs the current price ($0.53) and -7.1% vs the analyst target ($0.44). The current price implies the fleet earning a value-weighted blended **$39,039/day** (2.24× the current forward) — 2.9× the value-weighted 10-yr mean ($13,481, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
