...
The current price requires the fleet to run at **3.08× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **400,872** | — |
| 10-year mean | 35,805 | 11.20× |
| 12-month FFA | 130,041 | 3.08× |
| Current spot | 218,887 | 1.83× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| VLCC (66% of fleet value) | 477,812 | 11.95× |
| Suezmax (20% of fleet value) | 262,026 | 9.44× |
| LR2 (14% of fleet value) | 238,135 | 8.63× |
...
_Current price $38.13. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$26.54** is -30.4% vs the current price ($38.13) and -13.0% vs the analyst target ($30.50). The current price implies the fleet earning a value-weighted blended **$400,872/day** (3.08× the current forward) — 11.2× the value-weighted 10-yr mean ($35,805, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
