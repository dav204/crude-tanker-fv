...
The current price requires the fleet to run at **5.31× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.
...
_Current price $25.16. Cycle weights held at base across the grid._
