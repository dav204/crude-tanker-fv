...
- **Probability-weighted fair value:** $13.14 (-1.9% vs price)
...
- **Upside (best scenario − price):** $+11.02
- **Downside (worst scenario − price):** $-6.19
- **Expected value vs current** (weighted FV − price): $-0.26 (-1.9%)
