...
- **Probability-weighted fair value:** $29.73 (-2.0% vs price)
...
- **Upside (best scenario − price):** $+9.42
- **Downside (worst scenario − price):** $-16.53
- **Expected value vs current** (weighted FV − price): $-0.61 (-2.0%)
