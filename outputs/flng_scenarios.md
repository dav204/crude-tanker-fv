...
- **Breakeven TCE (scenario-invariant):** $206,030/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
- **Downside (worst scenario − price):** $-14.70
- **Expected value vs current** (weighted FV − price): $-0.14 (-0.4%)
