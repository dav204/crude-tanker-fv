...
- **Probability-weighted fair value:** $30.67 (-0.5% vs price)
- **Breakeven TCE (scenario-invariant):** $207,648/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
- **Upside (best scenario − price):** $+8.52
- **Downside (worst scenario − price):** $-14.73
- **Expected value vs current** (weighted FV − price): $-0.17 (-0.5%)
