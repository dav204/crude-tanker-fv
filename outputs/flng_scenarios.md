...
- **Probability-weighted fair value:** $29.73 (-4.4% vs price)
...
- **Upside (best scenario − price):** $+8.66
- **Downside (worst scenario − price):** $-17.29
- **Expected value vs current** (weighted FV − price): $-1.37 (-4.4%)
