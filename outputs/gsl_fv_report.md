...
Tool fair value **$43.00** is +12.8% vs the current price ($38.11) and -17.4% vs the analyst target ($52.04). NAV alone covers the price (NAV/sh $38.59 ≥ $38.11); the dividend strip provides no extra hurdle, so the implied breakeven floor is effectively zero — the market is pricing the fleet at a discount to vessel value.
