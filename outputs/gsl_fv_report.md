...
The current price requires the fleet to run at **0.84× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **46,961** | — |
| 10-year mean | 38,795 | 1.21× |
| 12-month FFA | 55,764 | 0.84× |
| Current spot | 57,970 | 0.81× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Ctr-Large (70% of fleet value) | 50,949 | 1.24× |
| Ctr-Intermediate (30% of fleet value) | 37,749 | 1.12× |
...
_Current price $41.24. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$43.06** is +4.4% vs the current price ($41.24) and -17.3% vs the analyst target ($52.04). The current price implies the fleet earning a value-weighted blended **$46,961/day** (0.84× the current forward) — 1.2× the value-weighted 10-yr mean ($38,795, i.e. the market is pricing extended peak rates), and the market is below the forward curve.
