...
- **Probability-weighted fair value:** $73.13 (-9.2% vs price)
...
- **Upside (best scenario − price):** $+10.20
- **Downside (worst scenario − price):** $-32.70
- **Expected value vs current** (weighted FV − price): $-7.45 (-9.2%)
