...
- **Probability-weighted fair value:** $73.13 (-4.0% vs price)
...
- **Upside (best scenario − price):** $+14.61
- **Downside (worst scenario − price):** $-28.29
- **Expected value vs current** (weighted FV − price): $-3.04 (-4.0%)
