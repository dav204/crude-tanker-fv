...
|---|---:|---:|
| **Implied breakeven (blended)** | **48,261** | — |
| 10-year mean | 20,829 | 2.32× |
| 12-month FFA | 45,911 | 1.05× |
| Current spot | 43,475 | 1.11× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (58% of fleet value) | 31,326 | 1.96× |
| LR2 (33% of fleet value) | 72,007 | 2.61× |
| LR1 (8% of fleet value) | 72,007 | 2.61× |
...
_Current price $32.96. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$32.62** is -1.0% vs the current price ($32.96) and +30.5% vs the analyst target ($25.00). The current price implies the fleet earning a value-weighted blended **$48,261/day** (1.05× the current forward) — 2.3× the value-weighted 10-yr mean ($20,829, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
