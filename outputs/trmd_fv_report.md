...
|---|---:|---:|
| **Implied breakeven (blended)** | **63,131** | — |
| 10-year mean | 20,829 | 3.03× |
| 12-month FFA | 45,911 | 1.38× |
| Current spot | 43,475 | 1.45× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (58% of fleet value) | 40,978 | 2.56× |
| LR2 (33% of fleet value) | 94,193 | 3.41× |
| LR1 (8% of fleet value) | 94,193 | 3.41× |
...
_Current price $35.08. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$32.62** is -7.0% vs the current price ($35.08) and +30.5% vs the analyst target ($25.00). The current price implies the fleet earning a value-weighted blended **$63,131/day** (1.38× the current forward) — 3.0× the value-weighted 10-yr mean ($20,829, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
