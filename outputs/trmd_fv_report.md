...
|---|---:|---:|
| **Implied breakeven (blended)** | **65,797** | — |
| 10-year mean | 20,829 | 3.16× |
| 12-month FFA | 45,911 | 1.43× |
| Current spot | 43,475 | 1.51× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (58% of fleet value) | 42,708 | 2.67× |
| LR2 (33% of fleet value) | 98,170 | 3.56× |
| LR1 (8% of fleet value) | 98,170 | 3.56× |
...
_Current price $35.46. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$32.62** is -8.0% vs the current price ($35.46) and +30.5% vs the analyst target ($25.00). The current price implies the fleet earning a value-weighted blended **$65,797/day** (1.43× the current forward) — 3.2× the value-weighted 10-yr mean ($20,829, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
