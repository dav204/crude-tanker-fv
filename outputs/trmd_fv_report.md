...
|---|---:|---:|
| **Implied breakeven (blended)** | **59,764** | — |
| 10-year mean | 20,829 | 2.87× |
| 12-month FFA | 45,911 | 1.30× |
| Current spot | 43,475 | 1.37× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (58% of fleet value) | 38,792 | 2.42× |
| LR2 (33% of fleet value) | 89,170 | 3.23× |
| LR1 (8% of fleet value) | 89,170 | 3.23× |
...
_Current price $34.60. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$32.62** is -5.7% vs the current price ($34.60) and +30.5% vs the analyst target ($25.00). The current price implies the fleet earning a value-weighted blended **$59,764/day** (1.30× the current forward) — 2.9× the value-weighted 10-yr mean ($20,829, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
