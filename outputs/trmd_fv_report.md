...
The current price requires the fleet to run at **0.62× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **30,223** | — |
| 10-year mean | 21,240 | 1.42× |
| 12-month FFA | 48,466 | 0.62× |
| Current spot | 34,849 | 0.87× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (55% of fleet value) | 15,434 | 0.96× |
| LR2 (36% of fleet value) | 48,173 | 1.75× |
| LR1 (9% of fleet value) | 48,173 | 1.75× |
...
Tool fair value **$30.97** is +8.9% vs the current price ($28.45) and +23.9% vs the analyst target ($25.00). The current price implies the fleet earning a value-weighted blended **$30,223/day** (0.62× the current forward) — 1.4× the value-weighted 10-yr mean ($21,240, i.e. the market is pricing extended peak rates), and the market is below the forward curve.
