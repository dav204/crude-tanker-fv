...
|---|---:|---:|
| **Implied breakeven (blended)** | **43,631** | — |
| 10-year mean | 21,221 | 2.06× |
| 12-month FFA | 48,379 | 0.90× |
| Current spot | 34,834 | 1.25× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (55% of fleet value) | 22,321 | 1.40× |
| LR2 (36% of fleet value) | 69,669 | 2.52× |
| LR1 (9% of fleet value) | 69,669 | 2.52× |
...
_Current price $30.28. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$30.94** is +2.2% vs the current price ($30.28) and +23.8% vs the analyst target ($25.00). The current price implies the fleet earning a value-weighted blended **$43,631/day** (0.90× the current forward) — 2.1× the value-weighted 10-yr mean ($21,221, i.e. the market is pricing extended peak rates), and the market is below the forward curve.
