...
|---|---:|---:|
| **Implied breakeven (blended)** | **81,099** | — |
| 10-year mean | 21,942 | 3.70× |
| 12-month FFA | 42,117 | 1.93× |
| Current spot | 53,987 | 1.50× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| LR2 (51% of fleet value) | 107,206 | 3.88× |
| MR (41% of fleet value) | 56,371 | 3.52× |
| Handymax (8% of fleet value) | 40,004 | 2.50× |
...
_Current price $78.03. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$72.23** is -7.4% vs the current price ($78.03) and -23.2% vs the analyst target ($94.00). The current price implies the fleet earning a value-weighted blended **$81,099/day** (1.93× the current forward) — 3.7× the value-weighted 10-yr mean ($21,942, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
