...
|---|---:|---:|
| **Implied breakeven (blended)** | **93,560** | — |
| 10-year mean | 20,965 | 4.46× |
| 12-month FFA | 47,221 | 1.98× |
| Current spot | 27,709 | 3.38× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (48% of fleet value) | 49,037 | 3.06× |
| LR1 (25% of fleet value) | 153,056 | 5.55× |
| LR2 (17% of fleet value) | 153,056 | 5.55× |
| Handysize (10% of fleet value) | 49,037 | 3.06× |
...
_Current price $7.48. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$5.99** is -20.0% vs the current price ($7.48) and -40.1% vs the analyst target ($10.00). The current price implies the fleet earning a value-weighted blended **$93,560/day** (1.98× the current forward) — 4.5× the value-weighted 10-yr mean ($20,965, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
