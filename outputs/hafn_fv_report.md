...
The current price requires the fleet to run at **4.39× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **191,620** | — |
| 10-year mean | 20,356 | 9.41× |
| 12-month FFA | 43,623 | 4.39× |
| Current spot | 30,439 | 6.30× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (54% of fleet value) | 130,900 | 8.18× |
| LR1 (23% of fleet value) | 300,894 | 10.90× |
| LR2 (14% of fleet value) | 300,894 | 10.90× |
| Handysize (8% of fleet value) | 92,025 | 5.75× |
...
_Current price $9.16. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$4.92** is -46.3% vs the current price ($9.16) and -50.8% vs the analyst target ($10.00). The current price implies the fleet earning a value-weighted blended **$191,620/day** (4.39× the current forward) — 9.4× the value-weighted 10-yr mean ($20,356, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
