...
- **Probability-weighted fair value:** $5.47 (-41.8% vs price)
- **Breakeven TCE (scenario-invariant):** $199,650/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
- **Upside (best scenario − price):** $-1.70
- **Downside (worst scenario − price):** $-7.11
- **Expected value vs current** (weighted FV − price): $-3.92 (-41.8%)
