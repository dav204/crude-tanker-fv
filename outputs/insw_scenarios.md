...
- **Probability-weighted fair value:** $48.00 (-42.2% vs price)
- **Breakeven TCE (scenario-invariant):** $304,545/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 10% | 1.25× | $65.76 | $77.87 | $73.97–$82.38 | 6.14× | 0.70 | $106.13 | $167,398 | 0.55× |
| Pre-MoU baseline | 20% | 0.82× | $50.79 | $52.57 | $50.75–$54.57 | 2.15× | 0.70 | $56.74 | $65,719 | 0.22× |
| MoU base case | 45% | 0.75× | $42.54 | $42.30 | $40.72–$43.96 | 1.77× | 0.70 | $42.17 | $48,249 | 0.16× |
| MoU bear | 25% | 0.71× | $39.55 | $38.53 | $36.88–$40.27 | 1.45× | 0.60 | $37.49 | $38,938 | 0.13× |
...
- **Upside (best scenario − price):** $-5.11
- **Downside (worst scenario − price):** $-46.91
- **Expected value vs current** (weighted FV − price): $-34.98 (-42.2%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.4% | $54.29 | $29.50 | -45.7% | TRIM/SHORT |
| Product | 34.6% | $28.69 | $18.50 | -35.5% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$82.98** | **$48.00** | **-42.2%** | **TRIM/SHORT** |
