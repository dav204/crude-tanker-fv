...
- **Probability-weighted fair value:** $52.93 (-38.6% vs price)
- **Breakeven TCE (scenario-invariant):** $330,395/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $65.76 | $77.87 | $73.97–$82.38 | 6.14× | 0.70 | $106.13 | $167,398 | 0.51× |
...
- **Upside (best scenario − price):** $-8.30
- **Downside (worst scenario − price):** $-50.10
- **Expected value vs current** (weighted FV − price): $-33.24 (-38.6%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.4% | $56.38 | $34.43 | -38.9% | TRIM/SHORT |
| Product | 34.6% | $29.79 | $18.50 | -37.9% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$86.17** | **$52.93** | **-38.6%** | **TRIM/SHORT** |
