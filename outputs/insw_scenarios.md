...
- **Probability-weighted fair value:** $59.32 (-43.3% vs price)
- **Breakeven TCE (scenario-invariant):** $569,780/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $68.10 | $80.41 | $76.43–$85.01 | 6.17× | 0.70 | $109.14 | $169,742 | 0.30× |
| Pre-MoU baseline | 62% | 0.93× | $57.03 | $58.39 | $56.53–$60.44 | 2.16× | 0.70 | $61.56 | $66,751 | 0.12× |
...
- **Downside (worst scenario − price):** $-64.66
- **Expected value vs current** (weighted FV − price): $-45.30 (-43.3%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.0% | $67.96 | $38.93 | -42.7% | TRIM/SHORT |
| Product | 35.0% | $36.66 | $20.39 | -44.4% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$104.62** | **$59.32** | **-43.3%** | **TRIM/SHORT** |
