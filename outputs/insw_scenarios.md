...
- **Probability-weighted fair value:** $59.91 (-46.1% vs price)
...
| Pre-MoU baseline | 59% | 0.93× | $57.03 | $58.39 | $56.53–$60.44 | 2.16× | 0.70 | $61.56 | $66,751 | 0.10× |
...
- **Downside (worst scenario − price):** $-71.25
- **Expected value vs current** (weighted FV − price): $-51.30 (-46.1%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.0% | $72.24 | $39.53 | -45.3% | TRIM/SHORT |
| Product | 35.0% | $38.97 | $20.39 | -47.7% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$111.21** | **$59.91** | **-46.1%** | **TRIM/SHORT** |
