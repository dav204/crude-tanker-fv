...
- **Probability-weighted fair value:** $59.59 (-40.3% vs price)
- **Breakeven TCE (scenario-invariant):** $546,679/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
- **Upside (best scenario − price):** $-19.35
- **Downside (worst scenario − price):** $-59.57
- **Expected value vs current** (weighted FV − price): $-40.17 (-40.3%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.0% | $64.80 | $39.25 | -39.4% | TRIM/SHORT |
| Product | 35.0% | $34.96 | $20.34 | -41.8% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$99.76** | **$59.59** | **-40.3%** | **TRIM/SHORT** |
