...
- **Probability-weighted fair value:** $61.81 (-39.4% vs price)
- **Breakeven TCE (scenario-invariant):** $543,938/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 28% | 1.25× | $68.10 | $80.41 | $76.43–$85.01 | 6.17× | 0.70 | $109.14 | $169,742 | 0.31× |
| Pre-MoU baseline | 59% | 1.00× | $59.35 | $61.53 | $59.46–$63.79 | 2.51× | 0.70 | $66.60 | $73,976 | 0.14× |
| MoU base case | 0% | 0.90× | $49.45 | $49.36 | $47.59–$51.21 | 2.06× | 0.70 | $49.55 | $54,492 | 0.10× |
| MoU bear | 13% | 0.80× | $44.38 | $42.87 | $41.42–$44.41 | 1.50× | 0.70 | $40.59 | $40,244 | 0.07× |
...
- **Upside (best scenario − price):** $-21.64
- **Downside (worst scenario − price):** $-61.73
- **Expected value vs current** (weighted FV − price): $-40.24 (-39.4%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.0% | $66.29 | $41.42 | -37.5% | TRIM/SHORT |
| Product | 35.0% | $35.76 | $20.39 | -43.0% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$102.05** | **$61.81** | **-39.4%** | **TRIM/SHORT** |
