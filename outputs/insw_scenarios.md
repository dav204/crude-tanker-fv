...
- **Probability-weighted fair value:** $61.34 (-27.4% vs price)
- **Breakeven TCE (scenario-invariant):** $316,781/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $65.76 | $77.87 | $73.97–$82.38 | 6.14× | 0.70 | $106.13 | $167,398 | 0.53× |
| Pre-MoU baseline | 45% | 1.09× | $60.37 | $65.86 | $63.44–$68.59 | 3.78× | 0.70 | $78.67 | $102,372 | 0.32× |
| MoU base case | 18% | 0.75× | $42.54 | $42.30 | $40.72–$43.96 | 1.77× | 0.70 | $42.17 | $48,249 | 0.15× |
...
- **Upside (best scenario − price):** $-6.62
- **Downside (worst scenario − price):** $-45.96
- **Expected value vs current** (weighted FV − price): $-23.15 (-27.4%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.4% | $55.28 | $40.41 | -26.9% | TRIM/SHORT |
| Product | 34.6% | $29.21 | $19.78 | -32.3% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$84.49** | **$61.34** | **-27.4%** | **TRIM/SHORT** |
