...
- **Probability-weighted fair value:** $54.21 (-38.5% vs price)
- **Breakeven TCE (scenario-invariant):** $346,197/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
- **Upside (best scenario − price):** $-10.25
- **Downside (worst scenario − price):** $-52.05
- **Expected value vs current** (weighted FV − price): $-33.91 (-38.5%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.4% | $57.65 | $34.43 | -40.3% | TRIM/SHORT |
| Product | 34.6% | $30.47 | $19.78 | -35.1% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$88.12** | **$54.21** | **-38.5%** | **TRIM/SHORT** |
