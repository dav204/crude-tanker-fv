...
- **Probability-weighted fair value:** $48.00 (-41.8% vs price)
- **Breakeven TCE (scenario-invariant):** $299,845/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 10% | 1.25× | $65.76 | $77.87 | $73.97–$82.38 | 6.14× | 0.70 | $106.13 | $167,398 | 0.56× |
...
- **Expected value vs current** (weighted FV − price): $-34.40 (-41.8%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.4% | $53.91 | $29.50 | -45.3% | TRIM/SHORT |
| Product | 34.6% | $28.49 | $18.50 | -35.1% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$82.40** | **$48.00** | **-41.8%** | **TRIM/SHORT** |
