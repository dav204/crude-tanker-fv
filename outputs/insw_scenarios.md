...
- **Probability-weighted fair value:** $59.91 (-43.2% vs price)
- **Breakeven TCE (scenario-invariant):** $577,573/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 28% | 1.25× | $68.10 | $80.41 | $76.43–$85.01 | 6.17× | 0.70 | $109.14 | $169,742 | 0.29× |
...
- **Upside (best scenario − price):** $-24.98
- **Downside (worst scenario − price):** $-65.43
- **Expected value vs current** (weighted FV − price): $-45.48 (-43.2%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.0% | $68.46 | $39.53 | -42.3% | TRIM/SHORT |
| Product | 35.0% | $36.93 | $20.39 | -44.8% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$105.39** | **$59.91** | **-43.2%** | **TRIM/SHORT** |
