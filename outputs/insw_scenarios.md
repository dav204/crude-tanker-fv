...
- **Probability-weighted fair value:** $59.91 (-41.3% vs price)
- **Breakeven TCE (scenario-invariant):** $544,843/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
- **Upside (best scenario − price):** $-21.73
- **Downside (worst scenario − price):** $-62.18
- **Expected value vs current** (weighted FV − price): $-42.23 (-41.3%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.0% | $66.35 | $39.53 | -40.4% | TRIM/SHORT |
| Product | 35.0% | $35.79 | $20.39 | -43.0% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$102.14** | **$59.91** | **-41.3%** | **TRIM/SHORT** |
