...
- **Probability-weighted fair value:** $59.47 (-23.8% vs price)
- **Breakeven TCE (scenario-invariant):** $342,121/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $65.52 | $74.11 | $71.27–$77.38 | 6.12× | 0.70 | $94.15 | $166,747 | 0.49× |
| Pre-MoU baseline | 45% | 1.09× | $60.16 | $63.97 | $62.22–$65.96 | 3.78× | 0.70 | $72.87 | $102,039 | 0.30× |
| MoU base case | 18% | 0.75× | $42.40 | $42.10 | $40.95–$43.31 | 1.77× | 0.70 | $41.81 | $48,109 | 0.14× |
| MoU bear | 12% | 0.71× | $39.42 | $38.16 | $36.96–$39.42 | 1.45× | 0.60 | $36.75 | $38,838 | 0.11× |
...
- **Upside (best scenario − price):** $-3.89
- **Downside (worst scenario − price):** $-39.84
- **Expected value vs current** (weighted FV − price): $-18.53 (-23.8%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.3% | $50.94 | $38.81 | -23.8% | TRIM/SHORT |
| Product | 34.7% | $27.06 | $19.54 | -27.8% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$78.00** | **$59.47** | **-23.8%** | **TRIM/SHORT** |
