...
- **Probability-weighted fair value:** $54.12 (-38.8% vs price)
- **Breakeven TCE (scenario-invariant):** $346,802/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $65.62 | $77.73 | $73.83–$82.24 | 6.11× | 0.70 | $106.01 | $166,090 | 0.48× |
| Pre-MoU baseline | 45% | 0.82× | $50.70 | $52.49 | $50.67–$54.49 | 2.15× | 0.70 | $56.67 | $65,383 | 0.19× |
| MoU base case | 18% | 0.75× | $42.46 | $42.23 | $40.65–$43.89 | 1.77× | 0.70 | $42.10 | $47,986 | 0.14× |
| MoU bear | 12% | 0.71× | $39.49 | $38.47 | $36.81–$40.20 | 1.45× | 0.60 | $37.42 | $38,757 | 0.11× |
...
- **Upside (best scenario − price):** $-10.67
- **Downside (worst scenario − price):** $-52.40
- **Expected value vs current** (weighted FV − price): $-34.28 (-38.8%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.3% | $57.74 | $34.32 | -40.6% | TRIM/SHORT |
| Product | 34.7% | $30.66 | $19.80 | -35.4% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$88.40** | **$54.12** | **-38.8%** | **TRIM/SHORT** |
