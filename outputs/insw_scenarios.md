...
- **Probability-weighted fair value:** $61.34 (-21.2% vs price)
- **Breakeven TCE (scenario-invariant):** $262,650/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $65.76 | $77.87 | $73.97–$82.38 | 6.14× | 0.70 | $106.13 | $167,398 | 0.64× |
| Pre-MoU baseline | 45% | 1.09× | $60.37 | $65.86 | $63.44–$68.59 | 3.78× | 0.70 | $78.67 | $102,372 | 0.39× |
| MoU base case | 18% | 0.75× | $42.54 | $42.30 | $40.72–$43.96 | 1.77× | 0.70 | $42.17 | $48,249 | 0.18× |
...
- **Upside (best scenario − price):** $+0.06
- **Downside (worst scenario − price):** $-39.28
- **Expected value vs current** (weighted FV − price): $-16.47 (-21.2%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.4% | $50.91 | $40.41 | -20.6% | TRIM/SHORT |
| Product | 34.6% | $26.90 | $19.78 | -26.5% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$77.81** | **$61.34** | **-21.2%** | **TRIM/SHORT** |
