...
- **Probability-weighted fair value:** $59.59 (-39.7% vs price)
- **Breakeven TCE (scenario-invariant):** $536,654/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $68.10 | $80.41 | $76.43–$85.01 | 6.17× | 0.70 | $109.14 | $169,742 | 0.32× |
...
- **Downside (worst scenario − price):** $-58.62
- **Expected value vs current** (weighted FV − price): $-39.22 (-39.7%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.0% | $64.18 | $39.25 | -38.8% | TRIM/SHORT |
| Product | 35.0% | $34.63 | $20.34 | -41.3% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$98.81** | **$59.59** | **-39.7%** | **TRIM/SHORT** |
