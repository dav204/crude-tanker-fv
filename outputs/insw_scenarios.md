...
- **Probability-weighted fair value:** $59.59 (-39.8% vs price)
- **Breakeven TCE (scenario-invariant):** $539,187/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $68.10 | $80.41 | $76.43–$85.01 | 6.17× | 0.70 | $109.14 | $169,742 | 0.31× |
| Pre-MoU baseline | 62% | 0.95× | $57.55 | $58.85 | $56.98–$60.89 | 2.16× | 0.70 | $61.88 | $66,751 | 0.12× |
...
- **Upside (best scenario − price):** $-18.64
- **Downside (worst scenario − price):** $-58.86
- **Expected value vs current** (weighted FV − price): $-39.46 (-39.8%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.0% | $64.34 | $39.25 | -39.0% | TRIM/SHORT |
| Product | 35.0% | $34.71 | $20.34 | -41.4% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$99.05** | **$59.59** | **-39.8%** | **TRIM/SHORT** |
