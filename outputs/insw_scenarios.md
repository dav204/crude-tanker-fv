...
- **Probability-weighted fair value:** $54.46 (-41.1% vs price)
- **Breakeven TCE (scenario-invariant):** $379,056/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $65.62 | $77.73 | $73.83–$82.24 | 6.11× | 0.70 | $106.01 | $166,090 | 0.44× |
| Pre-MoU baseline | 57% | 0.82× | $50.70 | $52.49 | $50.67–$54.49 | 2.15× | 0.70 | $56.67 | $65,383 | 0.17× |
| MoU base case | 5% | 0.75× | $42.46 | $42.23 | $40.65–$43.89 | 1.77× | 0.70 | $42.10 | $47,986 | 0.13× |
| MoU bear | 13% | 0.71× | $39.49 | $38.47 | $36.81–$40.20 | 1.45× | 0.60 | $37.42 | $38,757 | 0.10× |
...
- **Upside (best scenario − price):** $-14.68
- **Downside (worst scenario − price):** $-56.41
- **Expected value vs current** (weighted FV − price): $-37.95 (-41.1%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.3% | $60.36 | $34.66 | -42.6% | TRIM/SHORT |
| Product | 34.7% | $32.05 | $19.80 | -38.2% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$92.41** | **$54.46** | **-41.1%** | **TRIM/SHORT** |
