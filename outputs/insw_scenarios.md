...
- **Probability-weighted fair value:** $61.34 (-22.8% vs price)
- **Breakeven TCE (scenario-invariant):** $276,426/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Escalation | 25% | 1.25× | $65.76 | $77.87 | $73.97–$82.38 | 6.14× | 0.70 | $106.13 | $167,398 | 0.61× |
| Pre-MoU baseline | 45% | 1.09× | $60.37 | $65.86 | $63.44–$68.59 | 3.78× | 0.70 | $78.67 | $102,372 | 0.37× |
| MoU base case | 18% | 0.75× | $42.54 | $42.30 | $40.72–$43.96 | 1.77× | 0.70 | $42.17 | $48,249 | 0.17× |
| MoU bear | 12% | 0.71× | $39.55 | $38.53 | $36.88–$40.27 | 1.45× | 0.60 | $37.49 | $38,938 | 0.14× |
...
- **Downside (worst scenario − price):** $-40.98
- **Expected value vs current** (weighted FV − price): $-18.17 (-22.8%)
...
|---|--:|--:|--:|--:|---|
| Crude | 65.4% | $52.02 | $40.41 | -22.3% | TRIM/SHORT |
| Product | 34.6% | $27.49 | $19.78 | -28.0% | TRIM/SHORT |
| **WHOLE-COMPANY** | 100% | **$79.51** | **$61.34** | **-22.8%** | **TRIM/SHORT** |
