...
The current price requires the fleet to run at **0.12× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **10,261** | — |
| 10-year mean | 32,687 | 0.31× |
| 12-month FFA | 84,402 | 0.12× |
| Current spot | 74,557 | 0.14× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Aframax (50% of fleet value) | 9,392 | 0.26× |
| Suezmax (45% of fleet value) | 10,334 | 0.37× |
| VLCC (5% of fleet value) | 18,844 | 0.47× |
...
Tool fair value **$79.42** is +12.2% vs the current price ($70.80) and +5.9% vs the analyst target ($75.00). The current price implies the fleet earning a value-weighted blended **$10,261/day** (0.12× the current forward) — 0.3× the value-weighted 10-yr mean ($32,687, i.e. the market is pricing distress), and the market is below the forward curve.
