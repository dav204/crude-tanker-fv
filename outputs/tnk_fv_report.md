...
|---|---:|---:|
| **Implied breakeven (blended)** | **9,573** | — |
| 10-year mean | 32,687 | 0.29× |
| 12-month FFA | 84,402 | 0.11× |
| Current spot | 91,136 | 0.11× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Aframax (50% of fleet value) | 8,762 | 0.24× |
| Suezmax (45% of fleet value) | 9,641 | 0.35× |
| VLCC (5% of fleet value) | 17,581 | 0.44× |
...
_Current price $70.72. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$79.42** is +12.3% vs the current price ($70.72) and +5.9% vs the analyst target ($75.00). The current price implies the fleet earning a value-weighted blended **$9,573/day** (0.11× the current forward) — 0.3× the value-weighted 10-yr mean ($32,687, i.e. the market is pricing distress), and the market is below the forward curve.
