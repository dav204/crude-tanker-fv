...
|---|---:|---:|
| **Implied breakeven (blended)** | **49,193** | — |
| 10-year mean | 31,760 | 1.55× |
| 12-month FFA | 73,407 | 0.67× |
| Current spot | 76,589 | 0.64× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| Suezmax (54% of fleet value) | 59,291 | 2.14× |
| Aframax (46% of fleet value) | 37,310 | 1.02× |
...
_Current price $80.89. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$83.23** is +2.9% vs the current price ($80.89) and +11.0% vs the analyst target ($75.00). The current price implies the fleet earning a value-weighted blended **$49,193/day** (0.67× the current forward) — 1.5× the value-weighted 10-yr mean ($31,760, i.e. the market is pricing extended peak rates), and the market is below the forward curve.
