...
|---|--:|--:|--:|--:|---|
| BRUT | $8.80→$8.80 | +0.0% | +100.6%→+98.1% | -2.5 | BUY→BUY |
| TEN | $96.95→$88.70 | -8.5% | +97.1%→+81.9% | -15.1 | BUY→BUY |
| CCEC | $28.10→$28.10 | +0.0% | +65.6%→+65.6% | +0.0 | BUY→BUY |
| SB | $9.72→$10.12 | +4.1% | +47.1%→+53.4% | +6.2 | BUY→BUY |
| CAPT | $15.61→$15.49 | -0.7% | +39.4%→+37.4% | -2.0 | BUY→BUY |
| TNK | $83.32→$77.51 | -7.0% | +31.6%→+23.7% | -7.8 | BUY→BUY |
| TRMD | $31.65→$30.34 | -4.1% | +25.8%→+21.5% | -4.3 | BUY→BUY |
| ASC | $17.82→$17.80 | -0.1% | +18.3%→+18.1% | -0.2 | BUY→BUY |
| SBLK | $29.77→$29.34 | -1.4% | +15.7%→+14.3% | -1.4 | BUY→BUY |
| CMDB | $32.12→$31.33 | -2.4% | +14.8%→+12.2% | -2.6 | BUY→BUY |
| STNG | $80.97→$77.47 | -4.3% | +15.5%→+10.9% | -4.6 | BUY→BUY |
| CMBT **(WHOLE-CO)** | $15.84→$15.87 | +0.2% | +10.9%→+10.7% | -0.1 | BUY→BUY |
| GSL | $38.59→$38.59 | +0.0% | +7.4%→+7.4% | +0.0 | BUY→BUY |
| FLNG | $28.45→$28.45 | +0.0% | +7.2%→+7.2% | +0.0 | BUY→BUY |
| GNK | $25.53→$24.69 | -3.3% | +0.4%→-2.5% | -2.9 | HOLD→HOLD |
| DHT | $16.07→$13.88 | -13.7% | +7.8%→-4.6% | -12.4 | BUY→HOLD ⚠️ |
| HAFN | $5.69→$5.57 | -2.1% | -3.5%→-5.1% | -1.5 | HOLD→TRIM/SHORT ⚠️ |
| MPCC | $2.02→$2.02 | +0.0% | -13.0%→-13.0% | +0.0 | TRIM/SHORT→TRIM/SHORT |
| FRO | $28.47→$24.22 | -14.9% | -5.1%→-16.9% | -11.9 | TRIM/SHORT→TRIM/SHORT |
| ECO | $40.40→$34.35 | -15.0% | -8.4%→-19.9% | -11.5 | TRIM/SHORT→TRIM/SHORT |
| INSW **(WHOLE-CO)** | $57.91→$52.59 | -9.2% | -16.4%→-22.6% | -6.2 | TRIM/SHORT→TRIM/SHORT |
| NAT | $3.32→$2.79 | -15.8% | -31.7%→-40.1% | -8.4 | TRIM/SHORT→TRIM/SHORT |
