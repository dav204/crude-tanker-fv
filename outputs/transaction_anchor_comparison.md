...
|---|--:|--:|--:|--:|---|
| TEN | $95.21→$86.95 | -8.7% | +90.4%→+75.7% | -14.6 | BUY→BUY |
| CCEC | $28.10→$28.10 | +0.0% | +73.4%→+73.4% | +0.0 | BUY→BUY |
| SB | $9.92→$10.31 | +3.9% | +45.5%→+51.3% | +5.9 | BUY→BUY |
| TNK | $83.32→$77.51 | -7.0% | +24.5%→+17.1% | -7.4 | BUY→BUY |
| CMDB | $32.12→$31.33 | -2.4% | +19.6%→+16.9% | -2.7 | BUY→BUY |
| BRUT | $4.34→$4.34 | +0.0% | +14.6%→+12.2% | -2.4 | BUY→BUY |
| CMBT **(WHOLE-CO)** | $15.37→$15.40 | +0.2% | +11.4%→+11.3% | -0.1 | BUY→BUY |
| STNG | $83.87→$80.35 | -4.2% | +14.6%→+10.2% | -4.4 | BUY→BUY |
| GSL | $38.59→$38.59 | +0.0% | +7.4%→+7.4% | +0.0 | BUY→BUY |
| SBLK | $27.34→$26.91 | -1.6% | +8.4%→+6.9% | -1.5 | BUY→BUY |
| CAPT | $11.75→$11.58 | -1.4% | +8.6%→+6.5% | -2.2 | BUY→BUY |
| FLNG | $28.45→$28.45 | +0.0% | +4.1%→+4.1% | +0.0 | HOLD→HOLD |
| GNK | $25.53→$24.69 | -3.3% | +5.1%→+2.0% | -3.0 | BUY→HOLD ⚠️ |
| TRMD | $26.74→$25.43 | -4.9% | +6.1%→+1.9% | -4.2 | BUY→HOLD ⚠️ |
| ASC | $15.96→$15.93 | -0.2% | +0.3%→+0.2% | -0.2 | HOLD→HOLD |
| HAFN | $5.34→$5.22 | -2.2% | -13.7%→-15.2% | -1.5 | TRIM/SHORT→TRIM/SHORT |
| DHT | $14.70→$12.51 | -14.9% | -6.7%→-18.3% | -11.5 | TRIM/SHORT→TRIM/SHORT |
| MPCC | $2.02→$2.02 | +0.0% | -19.3%→-19.3% | +0.0 | TRIM/SHORT→TRIM/SHORT |
| FRO | $26.92→$22.67 | -15.8% | -10.9%→-22.5% | -11.6 | TRIM/SHORT→TRIM/SHORT |
| INSW **(WHOLE-CO)** | $57.91→$52.59 | -9.2% | -16.8%→-22.8% | -6.1 | TRIM/SHORT→TRIM/SHORT |
| ECO | $38.21→$32.16 | -15.8% | -12.0%→-23.5% | -11.5 | TRIM/SHORT→TRIM/SHORT |
