...
| GSL | $38.59→$38.59 | +0.0% | +6.5%→+6.5% | +0.0 | BUY→BUY |
...
| CMBT **(WHOLE-CO)** | $15.84→$15.87 | +0.2% | -8.8%→-8.4% | +0.5 | TRIM/SHORT→TRIM/SHORT |
| MPCC | $2.02→$2.02 | +0.0% | -13.7%→-13.7% | +0.0 | TRIM/SHORT→TRIM/SHORT |
| HAFN | $5.69→$5.57 | -2.1% | -18.8%→-20.1% | -1.3 | TRIM/SHORT→TRIM/SHORT |
| CAPT | $15.61→$15.49 | -0.7% | -22.6%→-24.2% | -1.6 | TRIM/SHORT→TRIM/SHORT |
| DHT | $16.07→$13.88 | -13.7% | -24.7%→-33.9% | -9.2 | TRIM/SHORT→TRIM/SHORT |
| BRUT | $8.80→$8.80 | +0.0% | -39.2%→-41.0% | -1.9 | TRIM/SHORT→TRIM/SHORT |
