...
|---|--:|--:|--:|--:|---|
| SB | $9.72→$10.12 | +4.1% | +49.3%→+55.6% | +6.3 | BUY→BUY |
| CCEC | $28.10→$28.10 | +0.0% | +54.5%→+54.5% | +0.0 | BUY→BUY |
| TEN | $96.95→$88.70 | -8.5% | +55.9%→+44.0% | -12.0 | BUY→BUY |
| ASC | $17.82→$17.80 | -0.1% | +14.4%→+14.2% | -0.1 | BUY→BUY |
| SBLK | $29.77→$29.34 | -1.4% | +15.0%→+13.6% | -1.4 | BUY→BUY |
| CMDB | $32.12→$31.33 | -2.4% | +14.3%→+11.7% | -2.6 | BUY→BUY |
| TRMD | $31.65→$30.34 | -4.1% | +13.1%→+9.1% | -3.9 | BUY→BUY |
| GSL | $38.59→$38.59 | +0.0% | +7.4%→+7.4% | +0.0 | BUY→BUY |
| TNK | $83.32→$77.51 | -7.0% | +11.3%→+5.1% | -6.2 | BUY→BUY |
| FLNG | $28.45→$28.45 | +0.0% | +2.0%→+2.0% | +0.0 | HOLD→HOLD |
| STNG | $80.97→$77.47 | -4.3% | +6.2%→+2.0% | -4.2 | BUY→HOLD ⚠️ |
| GNK | $25.53→$24.69 | -3.3% | -1.5%→-4.5% | -3.0 | HOLD→HOLD |
| CMBT **(WHOLE-CO)** | $15.84→$15.87 | +0.2% | -5.5%→-5.0% | +0.5 | TRIM/SHORT→TRIM/SHORT |
| MPCC | $2.02→$2.02 | +0.0% | -13.0%→-13.0% | +0.0 | TRIM/SHORT→TRIM/SHORT |
| HAFN | $5.69→$5.57 | -2.1% | -13.1%→-14.5% | -1.4 | TRIM/SHORT→TRIM/SHORT |
| CAPT | $15.61→$15.49 | -0.7% | -17.7%→-19.4% | -1.7 | TRIM/SHORT→TRIM/SHORT |
| DHT | $16.07→$13.88 | -13.7% | -21.7%→-31.3% | -9.6 | TRIM/SHORT→TRIM/SHORT |
| INSW **(WHOLE-CO)** | $57.91→$52.59 | -9.2% | -33.4%→-38.3% | -4.8 | TRIM/SHORT→TRIM/SHORT |
| BRUT | $8.80→$8.80 | +0.0% | -37.8%→-39.7% | -1.9 | TRIM/SHORT→TRIM/SHORT |
| FRO | $28.47→$24.22 | -14.9% | -38.4%→-47.6% | -9.2 | TRIM/SHORT→TRIM/SHORT |
| ECO | $40.40→$34.35 | -15.0% | -39.6%→-48.5% | -8.9 | TRIM/SHORT→TRIM/SHORT |
| NAT | $3.32→$2.79 | -15.8% | -52.9%→-59.5% | -6.6 | TRIM/SHORT→TRIM/SHORT |
