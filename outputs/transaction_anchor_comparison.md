...
|---|--:|--:|--:|--:|---|
| BRUT | $9.40→$9.40 | +0.0% | +104.8%→+102.4% | -2.4 | BUY→BUY |
| TEN | $95.95→$87.70 | -8.6% | +91.4%→+76.8% | -14.6 | BUY→BUY |
| CCEC | $28.10→$28.10 | +0.0% | +73.4%→+73.4% | +0.0 | BUY→BUY |
| SB | $9.48→$10.14 | +6.9% | +39.6%→+49.0% | +9.4 | BUY→BUY |
| CAPT | $15.20→$15.03 | -1.1% | +33.3%→+31.1% | -2.2 | BUY→BUY |
| TNK | $83.32→$77.51 | -7.0% | +24.5%→+17.1% | -7.4 | BUY→BUY |
| CMDB | $32.12→$31.33 | -2.4% | +19.6%→+16.9% | -2.7 | BUY→BUY |
| CMBT **(WHOLE-CO)** | $15.24→$15.27 | +0.2% | +11.0%→+10.9% | -0.1 | BUY→BUY |
...
| GNK | $25.48→$24.64 | -3.3% | +5.0%→+1.9% | -3.0 | HOLD→HOLD |
...
| DHT | $15.29→$13.10 | -14.3% | -3.9%→-15.5% | -11.5 | HOLD→TRIM/SHORT ⚠️ |
| FRO | $28.47→$24.22 | -14.9% | -7.2%→-18.9% | -11.6 | TRIM/SHORT→TRIM/SHORT |
| MPCC | $2.02→$2.02 | +0.0% | -19.3%→-19.3% | +0.0 | TRIM/SHORT→TRIM/SHORT |
| ECO | $39.93→$33.88 | -15.2% | -9.1%→-20.6% | -11.5 | TRIM/SHORT→TRIM/SHORT |
