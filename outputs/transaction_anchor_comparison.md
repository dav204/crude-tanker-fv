...
|---|--:|--:|--:|--:|---|
| BRUT | $9.40→$9.40 | +0.0% | +109.9%→+107.4% | -2.5 | BUY→BUY |
| TEN | $96.95→$88.70 | -8.5% | +98.1%→+83.1% | -15.0 | BUY→BUY |
| CCEC | $28.10→$28.10 | +0.0% | +72.0%→+72.0% | +0.0 | BUY→BUY |
| SB | $10.08→$10.47 | +3.9% | +50.6%→+56.8% | +6.2 | BUY→BUY |
| CAPT | $15.61→$15.49 | -0.7% | +36.8%→+34.8% | -2.0 | BUY→BUY |
| TNK | $83.32→$77.51 | -7.0% | +28.3%→+20.6% | -7.6 | BUY→BUY |
| SBLK | $29.77→$29.34 | -1.4% | +16.5%→+15.1% | -1.4 | BUY→BUY |
| CMBT **(WHOLE-CO)** | $15.84→$15.87 | +0.2% | +14.2%→+14.1% | -0.1 | BUY→BUY |
| STNG | $83.87→$80.35 | -4.2% | +18.6%→+14.1% | -4.5 | BUY→BUY |
| CMDB | $32.12→$31.33 | -2.4% | +16.2%→+13.6% | -2.6 | BUY→BUY |
| GSL | $38.59→$38.59 | +0.0% | +7.6%→+7.6% | +0.0 | BUY→BUY |
| FLNG | $28.45→$28.45 | +0.0% | +4.7%→+4.7% | +0.0 | HOLD→HOLD |
...
| MPCC | $2.02→$2.02 | +0.0% | -19.6%→-19.6% | +0.0 | TRIM/SHORT→TRIM/SHORT |
| INSW **(WHOLE-CO)** | $57.91→$52.59 | -9.2% | -15.0%→-21.2% | -6.2 | TRIM/SHORT→TRIM/SHORT |
| NAT | $2.63→$2.07 | -21.2% | -43.2%→-51.9% | -8.6 | TRIM/SHORT→TRIM/SHORT |
