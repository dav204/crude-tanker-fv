...
| CMDB | $32.62→$32.49 | -0.4% | +21.4%→+20.9% | -0.5 | BUY→BUY |
| TNK | $83.32→$77.51 | -7.0% | +24.5%→+17.1% | -7.4 | BUY→BUY |
| CMBT **(WHOLE-CO)** | $13.97→$15.26 | +9.2% | +2.7%→+11.0% | +8.4 | BUY→BUY |
| STNG | $83.87→$80.35 | -4.2% | +14.6%→+10.2% | -4.4 | BUY→BUY |
| GNK | $25.40→$26.27 | +3.4% | +4.7%→+7.8% | +3.1 | HOLD→BUY ⚠️ |
| GSL | $38.59→$38.59 | +0.0% | +7.4%→+7.4% | +0.0 | BUY→BUY |
| SBLK | $25.98→$26.57 | +2.3% | +3.6%→+5.6% | +2.0 | HOLD→BUY ⚠️ |
