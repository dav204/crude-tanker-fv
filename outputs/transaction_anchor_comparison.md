...
| TEN | $94.58→$87.35 | -7.7% | +52.6%→+42.0% | -10.6 | BUY→BUY |
| SB | $9.72→$10.12 | +4.1% | +28.6%→+34.1% | +5.5 | BUY→BUY |
| BRUT | $8.80→$8.80 | +0.0% | +13.3%→+11.3% | -2.0 | BUY→BUY |
| TRMD | $31.65→$30.34 | -4.1% | +12.3%→+8.4% | -3.8 | BUY→BUY |
| SBLK | $29.77→$29.34 | -1.4% | +5.6%→+4.3% | -1.3 | BUY→HOLD ⚠️ |
| ASC | $17.82→$17.80 | -0.1% | +4.2%→+4.0% | -0.1 | HOLD→HOLD |
| TNK | $83.32→$77.51 | -7.0% | +7.5%→+1.3% | -6.2 | BUY→HOLD ⚠️ |
| CMDB | $32.12→$31.33 | -2.4% | +3.2%→+0.8% | -2.4 | HOLD→HOLD |
| FLNG | $28.45→$28.45 | +0.0% | -0.4%→-0.4% | +0.0 | HOLD→HOLD |
| STNG | $80.97→$77.47 | -4.3% | +3.1%→-1.0% | -4.1 | HOLD→HOLD |
| GSL | $38.59→$38.59 | +0.0% | -1.7%→-1.7% | +0.0 | HOLD→HOLD |
| CAPT | $15.61→$15.49 | -0.7% | -0.2%→-1.9% | -1.7 | HOLD→HOLD |
| 2343 | $0.40→$0.39 | -4.6% | +0.7%→-3.3% | -4.1 | HOLD→HOLD |
| GNK | $25.53→$24.69 | -3.3% | -6.2%→-9.0% | -2.8 | TRIM/SHORT→TRIM/SHORT |
| CMBT **(WHOLE-CO)** | $15.84→$15.87 | +0.2% | -12.3%→-12.1% | +0.1 | TRIM/SHORT→TRIM/SHORT |
| HAFN | $5.69→$5.57 | -2.1% | -15.4%→-16.7% | -1.4 | TRIM/SHORT→TRIM/SHORT |
| MPCC | $2.04→$2.04 | +0.0% | -18.7%→-18.7% | +0.0 | TRIM/SHORT→TRIM/SHORT |
| LPG | $34.12→$34.11 | -0.0% | -26.6%→-26.6% | -0.0 | TRIM/SHORT→TRIM/SHORT |
| DHT | $16.07→$13.88 | -13.7% | -16.8%→-26.6% | -9.8 | TRIM/SHORT→TRIM/SHORT |
| BWLP | $15.81→$15.80 | -0.1% | -31.6%→-31.6% | -0.0 | TRIM/SHORT→TRIM/SHORT |
| INSW **(WHOLE-CO)** | $57.91→$52.59 | -9.2% | -33.7%→-38.5% | -4.8 | TRIM/SHORT→TRIM/SHORT |
| FRO | $28.47→$24.22 | -14.9% | -30.9%→-40.3% | -9.4 | TRIM/SHORT→TRIM/SHORT |
| ECO | $40.40→$34.35 | -15.0% | -34.6%→-43.4% | -8.8 | TRIM/SHORT→TRIM/SHORT |
| NAT | $3.32→$2.79 | -15.8% | -50.3%→-56.8% | -6.5 | TRIM/SHORT→TRIM/SHORT |
