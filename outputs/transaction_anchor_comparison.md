...
|---|--:|--:|--:|--:|---|
| BRUT | $9.62→$9.62 | +0.0% | +63.2%→+61.8% | -1.4 | BUY→BUY |
| TEN | $94.58→$88.16 | -6.8% | +69.5%→+58.9% | -10.6 | BUY→BUY |
| CCEC | $25.70→$25.70 | +0.0% | +49.2%→+49.2% | +0.0 | BUY→BUY |
| SB | $9.67→$10.58 | +9.4% | +16.6%→+27.8% | +11.2 | BUY→BUY |
| TRMD | $31.65→$30.22 | -4.5% | +20.4%→+15.9% | -4.5 | BUY→BUY |
| CMDB | $31.44→$32.13 | +2.2% | +11.7%→+13.7% | +2.1 | BUY→BUY |
| CAPT | $15.61→$15.48 | -0.8% | +12.6%→+11.0% | -1.6 | BUY→BUY |
| SBLK | $31.53→$32.78 | +4.0% | +3.1%→+6.8% | +3.7 | HOLD→BUY ⚠️ |
| FLNG | $28.45→$28.45 | +0.0% | +4.0%→+4.0% | +0.0 | HOLD→HOLD |
| GSL | $41.20→$41.20 | +0.0% | +4.0%→+4.0% | +0.0 | HOLD→HOLD |
| TNK | $89.65→$84.60 | -5.6% | +8.9%→+3.5% | -5.3 | BUY→HOLD ⚠️ |
| 2343 | $0.41→$0.41 | -1.9% | +3.1%→+1.4% | -1.7 | HOLD→HOLD |
| STNG | $79.63→$76.22 | -4.3% | +4.9%→+0.8% | -4.1 | HOLD→HOLD |
| ASC | $17.38→$17.37 | -0.0% | -1.7%→-1.8% | -0.0 | HOLD→HOLD |
| GNK | $24.77→$25.12 | +1.4% | -11.3%→-10.2% | +1.1 | TRIM/SHORT→TRIM/SHORT |
| HAFN | $5.69→$5.56 | -2.2% | -10.9%→-12.5% | -1.5 | TRIM/SHORT→TRIM/SHORT |
| CMBT **(WHOLE-CO)** | $15.84→$16.46 | +3.9% | -17.2%→-14.2% | +3.0 | TRIM/SHORT→TRIM/SHORT |
| DHT | $16.30→$15.01 | -8.0% | -8.9%→-15.2% | -6.3 | TRIM/SHORT→TRIM/SHORT |
| MPCC | $2.05→$2.05 | +0.0% | -18.8%→-18.8% | +0.0 | TRIM/SHORT→TRIM/SHORT |
| LPG | $35.70→$35.69 | -0.0% | -28.8%→-28.9% | -0.0 | TRIM/SHORT→TRIM/SHORT |
| FRO | $28.47→$25.34 | -11.0% | -22.9%→-30.3% | -7.5 | TRIM/SHORT→TRIM/SHORT |
| ECO | $43.80→$39.54 | -9.7% | -27.9%→-34.1% | -6.2 | TRIM/SHORT→TRIM/SHORT |
| BWLP | $15.81→$15.80 | -0.1% | -34.5%→-34.5% | -0.0 | TRIM/SHORT→TRIM/SHORT |
| INSW **(WHOLE-CO)** | $58.55→$54.64 | -6.7% | -32.0%→-35.7% | -3.7 | TRIM/SHORT→TRIM/SHORT |
| NAT | $3.32→$2.85 | -14.2% | -46.3%→-52.6% | -6.3 | TRIM/SHORT→TRIM/SHORT |
