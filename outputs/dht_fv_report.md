...
|---|---:|---:|
| **Implied breakeven (blended)** | **431,028** | — |
| 10-year mean | 40,000 | 10.78× |
| 12-month FFA | 155,000 | 2.78× |
| Current spot | 285,500 | 1.51× |
...
Tool fair value **$14.68** is -20.4% vs the current price ($18.45) and -8.2% vs the analyst target ($16.00). The current price implies the fleet earning a value-weighted blended **$431,028/day** (2.78× the current forward) — 10.8× the value-weighted 10-yr mean ($40,000, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
