...
|---|---:|---:|
| **Implied breakeven (blended)** | **31,172** | — |
| 10-year mean | 16,000 | 1.95× |
| 12-month FFA | 27,666 | 1.13× |
| Current spot | 55,100 | 0.57× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (76% of fleet value) | 33,576 | 2.10× |
| Handysize (24% of fleet value) | 23,604 | 1.48× |
...
Tool fair value **$17.26** is -2.0% vs the current price ($17.61) and -3.9% vs the analyst target ($17.95). Tool, market, and analyst are in broad agreement (all within ~5%). The current price implies the fleet earning a value-weighted blended **$31,172/day** (1.13× the current forward) — 1.9× the value-weighted 10-yr mean ($16,000, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
