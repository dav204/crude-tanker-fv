...
The current price requires the fleet to run at **0.98× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **24,202** | — |
| 10-year mean | 16,000 | 1.51× |
| 12-month FFA | 24,750 | 0.98× |
| Current spot | 35,600 | 0.68× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (92% of fleet value) | 24,202 | 1.51× |
| Handysize (8% of fleet value) | 24,202 | 1.51× |
...
Tool fair value **$16.77** is +0.4% vs the current price ($16.71) and -6.6% vs the analyst target ($17.95). The current price implies the fleet earning a value-weighted blended **$24,202/day** (0.98× the current forward) — 1.5× the value-weighted 10-yr mean ($16,000, i.e. the market is pricing extended peak rates), and the market is below the forward curve.
