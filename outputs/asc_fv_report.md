...
|---|---:|---:|
| **Implied breakeven (blended)** | **16,227** | — |
| 10-year mean | 16,000 | 1.01× |
| 12-month FFA | 24,750 | 0.66× |
| Current spot | 35,600 | 0.46× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (92% of fleet value) | 16,227 | 1.01× |
| Handysize (8% of fleet value) | 16,227 | 1.01× |
...
_Current price $15.82. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$16.77** is +6.0% vs the current price ($15.82) and -6.6% vs the analyst target ($17.95). The current price implies the fleet earning a value-weighted blended **$16,227/day** (0.66× the current forward) — 1.0× the value-weighted 10-yr mean ($16,000, i.e. the market is pricing extended peak rates), and the market is below the forward curve.
