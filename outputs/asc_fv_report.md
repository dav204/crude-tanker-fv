...
|---|---:|---:|
| **Implied breakeven (blended)** | **45,684** | — |
| 10-year mean | 16,000 | 2.86× |
| 12-month FFA | 27,666 | 1.65× |
| Current spot | 55,100 | 0.83× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (76% of fleet value) | 49,208 | 3.08× |
| Handysize (24% of fleet value) | 34,594 | 2.16× |
...
_Current price $19.05. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$17.26** is -9.4% vs the current price ($19.05) and -3.9% vs the analyst target ($17.95). The current price implies the fleet earning a value-weighted blended **$45,684/day** (1.65× the current forward) — 2.9× the value-weighted 10-yr mean ($16,000, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
