...
|---|---:|---:|
| **Implied breakeven (blended)** | **12,560** | — |
| 10-year mean | 16,000 | 0.79× |
| 12-month FFA | 24,750 | 0.51× |
| Current spot | 35,600 | 0.35× |

| Per-class implied breakeven | $/day | × its 10-yr mean |
|---|---:|---:|
| MR (92% of fleet value) | 12,560 | 0.79× |
| Handysize (8% of fleet value) | 12,560 | 0.79× |
...
Tool fair value **$16.75** is +8.8% vs the current price ($15.40) and -6.7% vs the analyst target ($17.95). The current price implies the fleet earning a value-weighted blended **$12,560/day** (0.51× the current forward) — 0.8× the value-weighted 10-yr mean ($16,000, i.e. the market is pricing distress), and the market is below the forward curve.
