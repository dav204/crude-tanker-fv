...
The current price requires the fleet to run at **1.91× the current forward curve** (inter-class rate ratios preserved). Headline is the value-weighted blended TCE across the fleet; per-class detail below.

| Benchmark (value-weighted blended) | $/day | vs breakeven |
|---|---:|---:|
| **Implied breakeven (blended)** | **249,084** | — |
| 10-year mean | 40,000 | 6.23× |
| 12-month FFA | 130,250 | 1.91× |
| Current spot | 790,800 | 0.31× |
...
_Current price $5.24. Cycle weights held at base across the grid._

## Divergence diagnosis

Tool fair value **$4.71** is -10.2% vs the current price ($5.24) and +3.2% vs the analyst target ($4.56). The current price implies the fleet earning a value-weighted blended **$249,084/day** (1.91× the current forward) — 6.2× the value-weighted 10-yr mean ($40,000, i.e. the market is pricing extended peak rates), and the market is above the forward curve.
