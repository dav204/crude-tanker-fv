...
|---|--:|--:|--:|---|---|
| LPG | -44.8% (TRIM/SHORT) | -43.1% (TRIM/SHORT) | -46.2% (TRIM/SHORT) | ✓ robust | position TRIM/SHORT across all 3 weight sets |
| BWLP | -43.2% (TRIM/SHORT) | -40.9% (TRIM/SHORT) | -44.9% (TRIM/SHORT) | ✓ robust | position TRIM/SHORT across all 3 weight sets |

## Per-name detail

### LPG — price $57.67, target $54.00

**Classification:** WEIGHT-ROBUST. position TRIM/SHORT across all 3 weight sets.

| Weight set | PW FV | EV % | Position |
|---|--:|--:|---|
| LPG Set A (locked 2026-07-07, evidence-first overhang-tilted) | $31.82 | -44.8% | TRIM/SHORT |
| LPG Set B (arb-bull / PDH-recovery bracket) | $32.84 | -43.1% | TRIM/SHORT |
| LPG Set C (deep-overhang bracket) | $31.00 | -46.2% | TRIM/SHORT |

### BWLP — price $25.55, target $17.52

**Classification:** WEIGHT-ROBUST. position TRIM/SHORT across all 3 weight sets.

| Weight set | PW FV | EV % | Position |
|---|--:|--:|---|
| LPG Set A (locked 2026-07-07, evidence-first overhang-tilted) | $14.52 | -43.2% | TRIM/SHORT |
| LPG Set B (arb-bull / PDH-recovery bracket) | $15.09 | -40.9% | TRIM/SHORT |
| LPG Set C (deep-overhang bracket) | $14.06 | -44.9% | TRIM/SHORT |
