...
|---|--:|--:|--:|---|---|
| LPG | -34.4% (TRIM/SHORT) | -31.8% (TRIM/SHORT) | -36.4% (TRIM/SHORT) | ✓ robust | position TRIM/SHORT across all 3 weight sets |
| BWLP | -36.3% (TRIM/SHORT) | -33.8% (TRIM/SHORT) | -38.3% (TRIM/SHORT) | ✓ robust | position TRIM/SHORT across all 3 weight sets |

## Per-name detail

### LPG — price $46.54, target $54.00

**Classification:** WEIGHT-ROBUST. position TRIM/SHORT across all 3 weight sets.

| Weight set | PW FV | EV % | Position |
|---|--:|--:|---|
| LPG Set A (locked 2026-07-07, evidence-first overhang-tilted) | $30.55 | -34.4% | TRIM/SHORT |
| LPG Set B (arb-bull / PDH-recovery bracket) | $31.75 | -31.8% | TRIM/SHORT |
| LPG Set C (deep-overhang bracket) | $29.58 | -36.4% | TRIM/SHORT |

### BWLP — price $22.70, target $17.52

**Classification:** WEIGHT-ROBUST. position TRIM/SHORT across all 3 weight sets.

| Weight set | PW FV | EV % | Position |
|---|--:|--:|---|
| LPG Set A (locked 2026-07-07, evidence-first overhang-tilted) | $14.46 | -36.3% | TRIM/SHORT |
| LPG Set B (arb-bull / PDH-recovery bracket) | $15.04 | -33.8% | TRIM/SHORT |
| LPG Set C (deep-overhang bracket) | $14.00 | -38.3% | TRIM/SHORT |
