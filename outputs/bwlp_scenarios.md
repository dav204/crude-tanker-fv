...
- **Probability-weighted fair value:** $14.52 (-39.9% vs price)
- **Breakeven TCE (scenario-invariant):** $255,029/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
- **Upside (best scenario − price):** $-5.87
- **Downside (worst scenario − price):** $-13.23
- **Expected value vs current** (weighted FV − price): $-9.63 (-39.9%)
