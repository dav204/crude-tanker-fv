...
- **Probability-weighted fair value:** $14.46 (-31.5% vs price)
- **Breakeven TCE (scenario-invariant):** $184,952/day — the value-weighted blended rate (fleet-mix-adjusted) that justifies the current price. The scenario sets the *probability* of clearing it, not the level.
...
- **Downside (worst scenario − price):** $-10.29
- **Expected value vs current** (weighted FV − price): $-6.64 (-31.5%)
