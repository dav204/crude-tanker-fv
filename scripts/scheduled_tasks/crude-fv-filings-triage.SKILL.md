---
name: crude-fv-filings-triage
description: Daily 11:45: disposition every EDGAR/MFN arrival in the complete unacknowledged queue (record-only / calendar / print / refresh-trigger / unreadable / owner), append decisions/filings_triage_log.md, ack the ledger so it stops flagging, commit. Owner ruling 2026-09-11: filings triage is agent work; a page means the owner acts.
