...
| `vie-exit-shadow` | lane | daily local scan via five-minute worker (24h due guard); after weekly broker harvests | `research/vie-exit/trial.json`, `inputs/research_mb/**/*.pdf`, `shipping_harvester/data/**`, `state/ffa_ocr_curves.json`, `inputs/ffa_drybulk/**` | `state/vie_exit/**` | none |
...
flowchart LR
  ...
  vie_exit_shadow["vie-exit-shadow"]
  ...
  delivery_worker -->|trigger| vie_exit_shadow
  ...
  harvester -->|data/**| vie_exit_shadow
  ...
  human_owner_chat -->|inputs/**| vie_exit_shadow
  ...
  news_pull -->|ffa_drybulk/**| vie_exit_shadow
  ...
  rocketchat_ingest -->|ffa_drybulk/**| vie_exit_shadow
