...
| `delivery-worker` | launchd | every five minutes and on load; catches up after sleep | `state/publications/**`, `state/delivery/**`, `governance:monitor/state/**`, `governance:monitor/seam_registry.json` | `state/publications/**`, `state/delivery/**`, `state/operations/**`, `state/heartbeat/delivery-worker`, `governance:monitor/state/**`, `governance:monitor/outbox/seam-*.md` | governor-seam |
