...
OFF_CONVENTION_QUEUE = {
    "CMBT", "ECO", "HAFN", "STNG", "TEN", "TRMD",
}  # NAT left 2026-06-30 (newbuilds parked; not parametrized); ASC left 2026-07-01 (newbuild an April-2026 subsequent event -> no 3/31 NB, so no longer an NB name)
